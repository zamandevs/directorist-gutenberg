...
export default function registerBlock({
  ...
  const templateContext = getLocalizedBlockDataByKey("template_context", {});
  const isContextualSiteTemplate = templateContext?.surface === "site_template";
  ...
  const metadataWithResponsiveWidth = {
    ...
    attributes: {
      ...(metadata.attributes || {}),
      block_width: metadata.attributes?.block_width || {
        type: "string",
        default: "100",
      },
      block_width_responsive: {
        type: "object",
        default: {
          desktop: normalizeWidthValue(
            metadata.attributes?.block_width?.default,
            "100",
          ),
          tablet: "",
          mobile: "",
  ...
  registerBlockType(metadataWithResponsiveWidth.name, {
    icon,
    example: {
      attributes: exampleAttributes,
    },
    edit: WrappedEdit,
    attributes: metadataWithResponsiveWidth.attributes,
    ...resolvedProps,
  });
}
